...
const createGameDuration = new Trend("efcore_create_game_duration", true);
const endGameDuration = new Trend("efcore_end_game_duration", true);
...
// POST /efcore/game/create
function createGame() {
  const res = http.post(`${BASE_URL}/efcore/game/create`, null, {
    headers: JSON_HEADERS,
  });
...
function endGame(gameId, playerId) {
  ...
  const res = http.post(`${BASE_URL}/efcore/game/end`, payload, {
    headers: JSON_HEADERS,
  });
